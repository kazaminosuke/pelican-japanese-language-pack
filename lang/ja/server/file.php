...
return [
    ...
    'actions' => [
        ...
        'copy' => [
            'title' => 'コピー',
            'notification' => 'ファイルをコピーしました',
        ],
        'upload' => [
            'title' => 'アップロード',
            'from_files' => 'ファイルをアップロード',
            'from_url' => 'URL からアップロード',
            'url' => 'URL',
            'drop_files' => 'ここにファイルをドロップ',
            'success' => 'ファイルを正常にアップロードしました',
        ...
        'rename' => [
            'title' => '名前を変更',
            'file_name' => 'ファイル名',
            'notification' => 'ファイル名を変更しました',
        ],
        'move' => [
            'title' => '移動',
            'directory' => 'ディレクトリ',
            'directory_hint' => '現在のディレクトリからの相対パスで新しいディレクトリを入力してください。',
            'new_location' => '新しい場所',
        ...
        'archive' => [
            'title' => 'アーカイブ',
            'archive_name' => 'アーカイブ名',
            'notification' => 'アーカイブを作成しました',
            'extension' => '拡張子',
        ],
        'unarchive' => [
            'title' => '展開',
            'notification' => '展開が完了しました',
        ],
        'new_file' => [
            'title' => '新規ファイル',
            'file_name' => '新しいファイル名',
